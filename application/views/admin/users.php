...
<div class="container_table">
	<p align="center">
		<?=anchor('users/add/' ,'Nuevo '.$new_img, 'title="Agregar Usuario"') ?>
	</p>
	...
	<?php
		...
		$this->table->set_heading('Nombres', 'Apellidos','Usuario', 'Rol', $edit_img, $delete_img);
		...
		{ 
	 	...
	 	else
	 	{
	    	...
	    	$this->table->add_row(
		        ...
		        $record->username,
		        $record->rol,
			        form_open('users/edit',$attributes).
			        form_hidden('id', $record->id).
			        form_submit('action', 'Editar').
			        form_close(),
		        $delete);								 
			$j++;						 			 
		}
