	...
	class Users extends CI_controller
	{
		...
		{ //Esta funcion agrega usuarios
			...
			else
			{
				...
				$insert = $this->Users_model->add_user($name, $last_name, $username, $rol, $password);
		...
		{ //Verificamos si el usario existe
		...
		function update()
		{ // Si los datos son válidos se actualiza el usuario de lo contrario se muestran los mensajes de error
			...
			else
			{
				...
				$insert = $this->Users_model->update_user($id, $name, $last_name, $username, $rol, $password);
				if($insert)
				{
